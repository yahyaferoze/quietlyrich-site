...
const featuresNormal = [
  ...
  },
  {
    ...
    description: 'Scroll-stopping captions, visuals, and pacing — optimized for viral reach.',
  },
  {
...
const featuresFantasy = [
  ...
  },
  {
    ...
    description: 'Access a library of legendary voices or invent your own. From Morgan Freeman to anime heroes.',
  },
  {
...
export default function VoiceFeatureGrid({ fantasyMode }: Props) {
  ...
  return (
    <section className="relative bg-[#0a0a0a] py-24 px-6 md:px-12 border-t border-[#1a1a1a] overflow-hidden">
      {/* Subtle blurred gradient accent for premium glass effect */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute w-[700px] h-[700px] left-[-250px] top-[-250px] bg-gradient-to-br from-[#6A00FF]/10 via-[#C2886D]/10 to-transparent blur-[120px] rounded-full"></div>
        <div className="absolute w-[500px] h-[500px] right-[-180px] bottom-[-180px] bg-gradient-to-tl from-[#9C4DFF]/10 via-[#C2886D]/10 to-transparent blur-[100px] rounded-full"></div>
      </div>
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-4xl md:text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-[#C2886D] via-[#9C4DFF] to-white"
        >
          {fantasyMode
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
          {features.map((feature, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className={`group p-7 bg-[#111]/80 border border-[#222] rounded-2xl shadow-lg shadow-[#9C4DFF]/10 transition-all hover:shadow-xl hover:-translate-y-1 hover:scale-[1.03]`}
            >
